## Davis Semicondutor
## Constraints file for 2-bit greater than comparator circuit
## 26-02-2021
...
## LEDs
set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { gt_out }]; #IO_L18P_T2_A24_15 Sch=led[0]
